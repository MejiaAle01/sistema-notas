      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDarkDropdown">
          <ol class="navbar-nav d-flex me-auto p-2 breadcrumb">
            ...
            <li class="breadcrumb-item text-white text-decoration-underline"> Lenguaje </li>
          </ol>
          <div class="d-flex">
            <ul class="navbar-nav">
    ...
    <section class="container-fluid table-responsive mt-2">
      ...
      <table class="table table-bordered table-dark table-striped">
        ...
        <tr>
          ...
          <td><?php echo $prom; ?></td>
          <td>
            <a class="bi-pencil-square link-warning fs-3 m-1" href="Editar_nota.php?Editar=<?php echo(base64_encode($IDN)); ?>&materia=<?php echo(base64_encode($materia)); ?>"></a>
            <a class="bi-trash link-danger fs-3 m-1" href="Eliminar_nota.php?Eliminar=<?php echo(base64_encode($IDN)); ?>"></a>
          </td>
        </tr>
          <?php } ?>
        </tbody>
